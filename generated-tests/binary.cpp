...
const string wasm_str_binary_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.0.wasm";
...
const string wasm_str_binary_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.1.wasm";
...
const string wasm_str_binary_2 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.2.wasm";
...
const string wasm_str_binary_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.3.wasm";
...
const string wasm_str_binary_48 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.48.wasm";
...
const string wasm_str_binary_53 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.53.wasm";
...
const string wasm_str_binary_54 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/binary.54.wasm";
