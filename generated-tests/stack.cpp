...
const string wasm_str_stack_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/stack.0.wasm";
...
const string wasm_str_stack_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/stack.1.wasm";
