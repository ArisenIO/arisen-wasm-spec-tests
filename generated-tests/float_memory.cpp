...
const string wasm_str_float_memory_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_memory.0.wasm";
...
const string wasm_str_float_memory_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_memory.1.wasm";
...
const string wasm_str_float_memory_2 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_memory.2.wasm";
...
const string wasm_str_float_memory_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_memory.3.wasm";
...
const string wasm_str_float_memory_4 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_memory.4.wasm";
...
const string wasm_str_float_memory_5 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_memory.5.wasm";
