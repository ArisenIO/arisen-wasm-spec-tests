...
const string wasm_str_func_ptrs_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/func_ptrs.0.wasm";
...
const string wasm_str_func_ptrs_8 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/func_ptrs.8.wasm";
...
const string wasm_str_func_ptrs_9 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/func_ptrs.9.wasm";
