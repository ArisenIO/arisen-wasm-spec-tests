...
const string wasm_str_start_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/start.3.wasm";
...
const string wasm_str_start_4 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/start.4.wasm";
...
const string wasm_str_start_5 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/start.5.wasm";
...
const string wasm_str_start_6 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/start.6.wasm";
