...
const string wasm_str_func_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/func.0.wasm";
...
const string wasm_str_func_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/func.1.wasm";
...
const string wasm_str_func_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/func.3.wasm";
