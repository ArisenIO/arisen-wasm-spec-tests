...
const string wasm_str_traps_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/traps.0.wasm";
...
const string wasm_str_traps_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/traps.1.wasm";
...
const string wasm_str_traps_2 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/traps.2.wasm";
...
const string wasm_str_traps_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/traps.3.wasm";
