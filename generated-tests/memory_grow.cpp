...
const string wasm_str_memory_grow_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory_grow.0.wasm";
...
const string wasm_str_memory_grow_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory_grow.1.wasm";
...
const string wasm_str_memory_grow_2 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory_grow.2.wasm";
...
const string wasm_str_memory_grow_4 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory_grow.4.wasm";
