...
const string wasm_str_memory_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.1.wasm";
...
const string wasm_str_memory_2 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.2.wasm";
...
const string wasm_str_memory_25 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.25.wasm";
...
const string wasm_str_memory_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.3.wasm";
...
const string wasm_str_memory_6 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.6.wasm";
...
const string wasm_str_memory_7 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.7.wasm";
...
const string wasm_str_memory_8 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory.8.wasm";
