...
const string wasm_str_float_literals_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_literals.0.wasm";
...
const string wasm_str_float_literals_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/float_literals.1.wasm";
