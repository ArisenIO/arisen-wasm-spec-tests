...
const string wasm_str_address_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/address.0.wasm";
...
const string wasm_str_address_2 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/address.2.wasm";
...
const string wasm_str_address_3 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/address.3.wasm";
...
const string wasm_str_address_4 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/address.4.wasm";
