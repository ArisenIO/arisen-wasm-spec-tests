...
const string wasm_str_memory_trap_0 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory_trap.0.wasm";
...
const string wasm_str_memory_trap_1 = base_dir + "/arisen-wasm-spec-tests/generated-tests/wasms/memory_trap.1.wasm";
