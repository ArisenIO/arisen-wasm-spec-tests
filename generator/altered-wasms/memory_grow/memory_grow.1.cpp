...
extern "C" {
   ...
   void sub_apply_0() {
      ...
      arisen::check(x4 == (int32_t)2, "_grow fail 4");

      int32_t x5 = _grow((int32_t)523);
      arisen::check(x5 == (int32_t)4, "_grow fail 5");

      int32_t x6 = _grow((int32_t)1);
      arisen::check(x6 == (int32_t)527, "_grow fail 6");

      int32_t x7 = _grow((int32_t)0);
      arisen::check(x7 == (int32_t)528, "_grow fail 7");
   }
